/**
 * g++ -std=c++11 test_custom_iterator.cpp
 */
...
int main()
{
    ...
    // while loop
    //-----------------------------------------------------
    fixed_array<double>::iterator it = point3d.begin();
    while (it != point3d.end())
    {
        std::cout << *it << " ";
        it++;
    }
