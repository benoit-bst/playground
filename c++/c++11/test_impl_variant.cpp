...
//***************************************************
// compile : g++ -std=c++11 test_impl_variant.cpp
//***************************************************
int main() {
     ...
     */
    {
        Union un1;
        un1.as_integer = 10;
        cout << "un1.as_integer " << un1.as_integer << endl;
        un1.as_bool = true;
        cout << "un1.as_integer " << un1.as_integer << endl;
    }
     ...
     */
    {
        Union2 un2;
        un2.as_integer = 10;
        un2.type_id = Union2::t_int;
    }

    /**
     * complex case : variadic template
     */
    {
